...
На главной странице открываем вкладку “Оплатить” (для этого кликаем по кнопке "Купить") => заполняем форму полностью валидными данными карты, которая не зарегестрирована в Альфа-банке => кнопка “Продолжить” кликаем => (ожидание 15 секунд - отправка запроса в банк) => Появляется уведомление об ошибке. Банк отказал в проведении операции.
